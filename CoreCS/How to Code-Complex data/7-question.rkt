...
#reader(lib "htdp-beginner-abbr-reader.ss" "lang")((modname 7-question) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))

(define-struct person (name age children))
;; Person is (make-person String Natural ListOfPerson)
;; iterp. a person with first name, age and a list of their children
